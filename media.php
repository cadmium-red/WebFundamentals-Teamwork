...
<head>
<!-- META -->
<title>Hardcore University | Gallery</title>
<meta charset="UTF-8">
    ...
    <!-- Page Content -->
			<div class="container">
			  <div class="row">
				...
				<div class="row">
				  <div class="col-lg-3 col-sm-4 col-xs-6"><a title="Изморени и мислещи за биричка по-време на 12та-та лекция за деня." href="#"><img class="thumbnail img-responsive" src="img/gallery/IMG_6332.JPG" alt="tired"></a></div>
				  ...
				  <div class="col-lg-3 col-sm-4 col-xs-6"><a title="Хаков пак ще пие." href="#"><img class="thumbnail img-responsive" src="img/gallery/harduni_life1.jpg" alt="HardUni Img1"></a></div>
				  <div class="col-lg-3 col-sm-4 col-xs-6"><a title="Плевналиев не подозира за случващото се." href="#"><img class="thumbnail img-responsive" src="img/gallery/harduni_life2.jpg"  alt="HardUni Img2"></a></div>
				  ...
				  <div class="col-lg-3 col-sm-4 col-xs-6"><a title="Диамантииии..." href="#"><img class="thumbnail img-responsive" src="img/gallery/harduni_life5.jpg" alt="HardUni Img5"></a></div>
		...
		<div class="modal" id="myModal" role="dialog">
		  ...
		  <div class="modal-content">
			<div class="modal-header">
				...
				<h3 class="modal-title">Галерия</h3>
			</div>
